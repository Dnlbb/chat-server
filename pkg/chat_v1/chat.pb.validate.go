...
func (m *CreateRequest) validate(all bool) error {
	...
	if l := len(m.GetUsernames()); l < 1 || l > 10 {
...
func (m *SendMessageRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetFromUserName()); l < 1 || l > 255 {
	...
	if l := utf8.RuneCountInString(m.GetBody()); l < 1 || l > 555 {
		err := SendMessageRequestValidationError{
			field:  "Body",
			reason: "value length must be between 1 and 555 runes, inclusive",
		}
		if !all {
			return err
		}
